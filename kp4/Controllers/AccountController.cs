        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //если нужно зарегать в системе врача то в 161 надо прописать "doctor", и раскомментить три строки ниже, а следующие строки про пациента закомментить

                    //Doctor doc = new Doctor { login = email };
                    //db.Doctor.Add(doc);
                    //db.SaveChanges();

                    //если в строке 161 стоит пациент то при регистрации будет создаваться пациент в базе данных и строке ниже должны быть раскомменчены
